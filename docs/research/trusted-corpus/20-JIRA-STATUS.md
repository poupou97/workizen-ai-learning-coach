# 20 — Jira / GitHub status

| item | key / link | state |
|---|---|---|
| this research workstream | **WAL-208** — [RESEARCH] Trusted-Corpus Feasibility Study (TC-v1) … — child of epic **WAL-195** ([ARCH] Education Data Architecture & Learning Graph Research) | created 2026-09-05; results + verdict posted as a comment; moved to Done when the PR merged |
| running P0 layout ticket (NOT reused) | WAL-206 — [P0] Layout-aware K–12 extraction (XY-cut) | linked "relates to" WAL-208; its result doc is `docs/research/WAL-206-LAYOUT-EXTRACTION-RESULT.md` on branch `feat/wal-206-layout-aware-extraction` |
| earlier failure this study re-audits | WAL-204 — P0 pattern-router experiment (FAIL) | referenced; the failure page was located (KHTN 7 PDF p32) and is gold page #3 |
