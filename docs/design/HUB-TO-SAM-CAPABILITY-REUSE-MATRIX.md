...
| Smart Canvas | feature `canvas` (39 files) | Problem Workspace viết tay, diagram, map-annotate, mindmap | **POC/ADAPT** (§27.4) | audit object-model/persistence/stylus trước; không ép mọi môn (F41) |
| Smart Tools (summarize/mindmap/present/extract) | `smart_tools`, mindmap 17 files | tóm tắt bài, sơ đồ tư duy, project | REUSE + age/subject-gate | output = learner artifact, KHÔNG curriculum truth |
