...
import '../subjects/grade_subjects.dart';
...
class SettingsScreen extends StatelessWidget {
      ...
      child: ListView(
        ...
        children: [
          ...
          Material(
            ...
            child: ListTile(
              ...
              onTap: () => Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (_) => DiscoveryLibraryScreen(stories: stories),
                ),
              ),
            ),
          ),
          ...
          if (profile != null && store != null) ...[
            ...
            // thanh dưới. Bỏ lối vào thứ hai ở đây: hai cửa vào cùng một màn
            // làm trẻ tưởng là hai thứ khác nhau, và §9 cấm nhân bản màn.
            ...
            _entry(
              ...
              (c) => TimetableScreen(
                profile: profile!,
                store: store!,
                // ⭐ Lệnh 51 §8 — môn ĐÃ CHUẨN HOÁ BOOK→SUBJECT: Tập 1
                // và Tập 2 của một môn là MỘT môn, không phải hai.
                subjects: index == null
                    ? const <String>[]
                    : gradeSubjectNames(index!),
              ),
            ),
          ],
          const SizedBox(height: WalSpacing.md),
  ...
  Widget _entry(
    ...
    child: ListTile(
      ...
      trailing: const Icon(Icons.chevron_right, color: WalColors.primaryText),
      onTap: () =>
