...
def build(out_dir):
    ...
    blocks = [
        ...
        {'id': f'{BOOK}:p061:synthetic:fig1', 'type': 'image', 'sourceRef': ref(61, 60, [0.1, 0.4, 0.4, 0.3], None), 'trust': TRUST,
         'crop': 'crops/synthetic-fig-1.png', 'captionBlockId': f'{BOOK}:p061:synthetic:007', 'labels': 0, 'aspect': 600 / 320},
        ...
        {'id': f'{BOOK}:p062:synthetic:fig2', 'type': 'image', 'sourceRef': ref(62, 61, [0.2, 0.68, 0.3, 0.17], None), 'trust': TRUST,
         'crop': 'crops/synthetic-fig-2.png', 'captionBlockId': None, 'labels': 0, 'aspect': 600 / 320},
